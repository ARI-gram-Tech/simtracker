...
export const ENDPOINTS = {
  ...
  DELETE_REPORT:    (id: number) => `${BASE_URL}/reconciliation/${id}/delete/`,
  ...
  DELETE_CYCLE:            (id: number) => `${BASE_URL}/commissions/cycles/${id}/delete/`,  
  ...
  CLEAR_ALL:      `${BASE_URL}/notifications/clear-all/`,   
